...
const spaceTexture = new THREE.TextureLoader().load(spaceImage); // create texture w/image
scene.background = spaceTexture; // set background to texture


// AVATAR

const adelinaTexture = new THREE.TextureLoader().load(adelinaImage); // create texture w/image
...
const ballTexture = new THREE.TextureLoader().load(discoImage); // create texture w/image
const normalTexture = new THREE.TextureLoader().load(normalImage); // create texture w/normal image
